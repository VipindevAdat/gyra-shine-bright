    ...
    <div className="container relative z-10 py-20">
      <div className="max-w-2xl animate-fade-up">
        ...
        <p className="text-lg text-primary-foreground/80 mb-8 leading-relaxed max-w-xl">
          GYRA is a 501(c)(3) nonprofit organization that empowers students in grades 1–12 through real-world research opportunities, fostering curiosity, critical thinking, and a passion for discovery with guidance from expert mentors around the world.
        </p>
